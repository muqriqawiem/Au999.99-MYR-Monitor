...
const TRANSLATIONS: Record<string, Record<string, any>> = {
  en: {
    ...
    calculator_sub: "Convert between MYR and grams using current RM/g price",
    calculator_myr: "MYR",
    calculator_gram: "Gold grams",
    calculator_input_myr: "Enter MYR",
    calculator_input_gram: "Enter grams",
    calculator_note: "Based on current Au 999.9 price",
  ...
  bm: {
    ...
    hero_eyebrow: "Harga spot emas · 24K tulen · MYR per gram",
    hero_unit: "MYR / gram",
    today_change: "hari ini",
    m_oz_lbl: "Harga per troy auns",
    m_fx_lbl: "Kadar USD / MYR",
    ...
    calculator_sub: "Tukar antara MYR dan gram menggunakan harga semasa RM/g",
    calculator_myr: "MYR",
    calculator_gram: "Gram emas",
    calculator_input_myr: "Masukkan MYR",
    calculator_input_gram: "Masukkan gram",
    calculator_note: "Berdasarkan harga Au 999.9 semasa",
    alert_placeholder: "RM / gram",
    ...
    invalid_price: "Masukkan harga MYR yang sah per gram.",
    ...
    ch_title: "Julat 30 Hari · Tertinggi · Purata · Terendah Harian · MYR/gram",
    ...
    ch_ok: (n: number, r: string) => `${n} hari dimuatkan · USD/MYR ${r}`,
    ch_err: (m: string) => `⚠ ${m}`,
